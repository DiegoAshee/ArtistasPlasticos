...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= URL_BASE ?>options/update" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?= $option['idOption'] ?>">
                
                <div class="form-group">
                    <label for="title">Título *</label>
                    <input type="text" class="form-control" id="title" name="title" required 
                           minlength="3" maxlength="100" value="<?= htmlspecialchars($option['title']) ?>"
                ...
                <div class="form-group">
                    ...
                    <img src="<?= URL_BASE . $option['imageURL'] ?>" alt="Logo actual" class="img-fluid mb-2" style="max-height: 150px;">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="logo">Seleccionar nueva imagen (JPG, PNG, GIF, WEBP - máximo 2MB)</label>
                    </div>
                    <small class="form-text text-muted">Si selecciona una nueva imagen, reemplazará la actual.</small>
                </div>
